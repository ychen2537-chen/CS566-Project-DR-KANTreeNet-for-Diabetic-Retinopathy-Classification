...
This repository includes an interactive website showcasing the DR-KANTreeNet project. The website provides:

- **Visual comparisons** between normal and DR-affected retinas
- **Interactive pipeline visualization** showing the step-by-step processing
- **Performance metrics** and comparative analysis
- **AI-powered chat assistant** for project questions

### Website Setup

The website is built with React, TypeScript, and Vite. To run locally:
...
The website is configured for GitHub Pages deployment at:
`https://ychen2537-chen.github.io/CS566-Project-DR-KANTreeNet-for-Diabetic-Retinopathy-Classification/`
